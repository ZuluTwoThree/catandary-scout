  ...
  return (
    <footer className="bg-foreground text-primary-foreground py-12 md:py-16">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="md:col-span-2">
            <Link to="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-semibold">Catandary</span>
            </Link>
          ...
          <div>
            ...
            <nav className="flex flex-col gap-2">
              ...
              <Link to="/imprint" className="text-sm text-muted-foreground hover:text-primary-foreground transition-colors">
                {t('footer.imprint')}
              </Link>
        ...
        {/* Bottom Bar */}
        <div className="border-t border-muted-foreground/20 mt-8 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-muted-foreground">
            © {currentYear} Catandary. All rights reserved.
          </p>
